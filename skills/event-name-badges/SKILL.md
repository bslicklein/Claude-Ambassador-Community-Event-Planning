...
## Where to buy the stock and print it

**Staples** is the badge vendor. Two ways to do it, and the choice is about time,
not money:

- **Buy the stock, print it yourself.** Staples carries Avery 74541 clip-style
  badge kits and 5395 adhesive stock in store. This is the better path whenever
  there is a printer on hand, because the paper test sheet, the reprint after a
  late RSVP, and the ten walk-up blanks all cost nothing.
- **Print & Marketing Services.** Hand them `badges-print.pdf` and the box of
  stock. Say **100% scale, actual size, single sided, no fit-to-page** out loud
  and write it on the order; a shop that scales to fit will walk every badge off
  the perforations. Confirm the turnaround in writing, and pick up the day before.

Either way, buy roughly **15% more stock than the headcount**. Walk-ups, misspellings
caught at the door, and one jammed sheet all come out of the same box.

Banners go to Vistaprint and the welcome board to FedEx Office; different products,
different vendors, on purpose.
